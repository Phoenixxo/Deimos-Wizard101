...
class GUICommandType(Enum):
    ...
    PopulateCamera = auto()
    PopulatePlayerGID = auto()   # GUI -> Backend: fetch player GID into CamEntityGIDInput

    RebindHotkey = auto()        # GUI -> Backend: (action_id, key, modifiers) or (action_id, None, None)
    FriendTeleport = auto()      # GUI -> Backend
    ToggleDialogueSideQuests = auto()  # GUI -> Backend

    InvokeAction = auto()       # Backend -> GUI: action_id (triggers button callback)
...
_QT_KEY_TO_KEYCODE = {
    Qt.Key.Key_Backspace: "BACK", Qt.Key.Key_Tab: "TAB", Qt.Key.Key_Return: "RETURN",
    Qt.Key.Key_Enter: "RETURN", Qt.Key.Key_Pause: "PAUSE", Qt.Key.Key_CapsLock: "CAPITAL",
    Qt.Key.Key_Escape: "ESCAPE", Qt.Key.Key_Space: "SPACE", Qt.Key.Key_PageUp: "PRIOR",
    Qt.Key.Key_PageDown: "NEXT", Qt.Key.Key_End: "END", Qt.Key.Key_Home: "HOME",
    Qt.Key.Key_Left: "LEFT", Qt.Key.Key_Up: "UP", Qt.Key.Key_Right: "RIGHT",
    Qt.Key.Key_Down: "DOWN", Qt.Key.Key_Insert: "INSERT", Qt.Key.Key_Delete: "DELETE",
    Qt.Key.Key_0: "ZERO", Qt.Key.Key_1: "ONE", Qt.Key.Key_2: "TWO",
    Qt.Key.Key_3: "THREE", Qt.Key.Key_4: "FOUR", Qt.Key.Key_5: "FIVE",
    Qt.Key.Key_6: "SIX", Qt.Key.Key_7: "SEVEN", Qt.Key.Key_8: "EIGHT",
    Qt.Key.Key_9: "NINE",
    ...
    Qt.Key.Key_NumLock: "NUMLOCK", Qt.Key.Key_ScrollLock: "SCROLL",
    Qt.Key.Key_Semicolon: "OEM_1", Qt.Key.Key_Equal: "OEM_PLUS",
    Qt.Key.Key_Comma: "OEM_COMMA", Qt.Key.Key_Minus: "OEM_MINUS",
    Qt.Key.Key_Period: "OEM_PERIOD", Qt.Key.Key_Slash: "OEM_2",
    Qt.Key.Key_QuoteLeft: "OEM_3", Qt.Key.Key_BracketLeft: "OEM_4",
    Qt.Key.Key_Backslash: "OEM_5", Qt.Key.Key_BracketRight: "OEM_6",
    Qt.Key.Key_Apostrophe: "OEM_7",
}

# Bare modifier keys to ignore (only fire when combined with a real key)
_MODIFIER_KEYS = {
...
def _format_binding(key: str | None, modifiers: list[str] | None) -> str:
    """Format a key binding for display, e.g. 'Shift+F4' or 'Unbound'."""
    if key is None:
        return "Unbound"
    parts = []
    if modifiers:
